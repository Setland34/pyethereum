...
def process_transactions(block, transactions):
    """
    Process a list of transactions for a given block.

    Args:
        block (Block): The block to process transactions for.
        transactions (list): The list of transactions to process.

    Returns:
        None

    Raises:
        Exception: If there is an error processing a transaction.
    """
...
def eval(block, transactions, timestamp, coinbase):
    """
    Evaluate a block with a list of transactions.

    Args:
        block (Block): The block to evaluate.
        transactions (list): The list of transactions to process.
        timestamp (int): The timestamp of the block.
        coinbase (str): The coinbase address for the block.

    Returns:
        Block: The evaluated block.

    Raises:
        Exception: If there is an error evaluating the block.
    """
    h = block.hash()
    ...
    for uncle in block.uncles:
        sib_miner_state = rlp.decode(block.state.get(uncle[3]))
...
def eval_contract(block, transaction_list, tx):
    """
    Evaluate a contract for a given transaction.

    Args:
        block (Block): The block containing the contract.
        transaction_list (list): The list of transactions to process.
        tx (Transaction): The transaction to evaluate the contract for.

    Returns:
        None

    Raises:
        Exception: If there is an error evaluating the contract.
    """
